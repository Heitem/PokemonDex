...
//  Pokedex
//
//  Created by Heitem OULED-LAGHRIYEB on 9/16/17.
    ...
    func downloadPokemonDetails(completed: @escaping DownloadComplete) {
        ...
        Alamofire.request(_pokemonURL).responseJSON { (response) in
            ...
            if let dict = response.result.value as? Dictionary<String, AnyObject> {
                ...
                print(self._weight, self._height, self._attack, self._defense, self._type, self._description, self._nextEvolutionLevel, self._nextEvolutionName, self._nextEvolutionId)
            }
            completed()
        }
    }
